            ...
            <div class="col-md-8 offset-md-2 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3>Tambahkan Wakasau</h3>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="form-group mb-3">
                                <label for="nama">Nama Wakasau</label>
                                <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Wakasau">
                            </div>
                            <div class="form-group mb-3">
                                <label for="nama">Masa Jabatan</label>
                                <input type="text" class="form-control" id="nama" placeholder="Masukkan Masa Jabatan Wakasau">
                            </div>
                            <div class="form-group mb-3">
                                <label for="imageUpload">Upload Foto Wakasau</label>
                                <div class="row">
